...
pygame.display.set_caption("Gestion des réserves naturelles")
...
# Title
title = Label(
    "Gestion des réserves naturelles", 20, 0,
...
visualise_btn.rect.left = speed_btn.rect.right + 50
#
...
generate_btn.rect.left = visualise_btn.rect.right + 50
...
def draw() -> None:
    ...
    if not state.maze_generated:
        ...
        # Generate maze using a default algorithm
    #     maze.clear_board()

    #     def callback():
    #         state.overlay = False
    #         state.label = Label(
    #             "Basic Random Maze Generated", "center", 0,
    #             background_color=pygame.Color(*WHITE),
    #             foreground_color=pygame.Color(*DARK),
    #             padding=6, font_size=20, outline=False,
    #             surface=WINDOW,
    ...
    #     maze.generate_maze(algorithm="Basic Random", after_generation=callback)
